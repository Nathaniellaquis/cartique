...
export function SupplierMessagesPage() {
  ...
  // Mock threads (from customer perspective)
  const threads: Thread[] = [
    {
      ...
      carId: "1",
      lastMessage: "I'd like to book this for Nov 1-4. Is it available?",
      timestamp: "2h ago",
      unread: true
    },
    {
      ...
      carId: "2",
      lastMessage: "Can you do a discount for a week-long rental?",
      timestamp: "1d ago",
      unread: true
    },
    {
      ...
      carId: "4",
      lastMessage: "Thanks! I'll proceed with the booking.",
      timestamp: "3d ago",
      unread: false
    }
  ]
  ...
  const messages: Message[] = selectedThreadId ? [
    ...
    },
    {
      id: "2",
      from: "supplier",
      text: "Hello Michael! Yes, the McLaren 720S is available for those dates. It's a fantastic choice for a weekend drive!",
      timestamp: "2 days ago"
    },
    {
      id: "3",
    ...
    },
    {
      id: "5",
      from: "customer",
      text: "Thanks! Where should I pick up the car?",
      timestamp: "1 day ago"
    },
    {
      id: "6",
      from: "supplier",
      text: "I can meet you at your hotel in Beverly Hills, or you can come to my garage. Whatever works best for you!",
      timestamp: "2h ago"
    }
  ] : []
  ...
  return (
    <div className="h-screen bg-gradient-to-b from-zinc-950 via-black to-zinc-950 pt-20">
      <div className="h-[calc(100vh-80px)] max-w-7xl mx-auto px-6 py-6 flex gap-6">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-1">
                          <h3 className="font-bold text-sm text-white truncate">{thread.customerName}</h3>
        ...
        {selectedThreadId && selectedThread && car ? (
          <div className={cn(
            ...
            <div className="p-6 border-b border-white/10 flex items-center gap-4">
              ...
              <div className="flex-1">
                <h2 className="font-bold text-white">{selectedThread.customerName}</h2>
                <div className="flex items-center gap-2 text-sm text-zinc-400">
                  <span>Re: {car.name}</span>
                  <span>•</span>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              ...
              {messages.map((message) => (
                <div
                  ...
                  className={cn(
                    "flex",
                    message.from === "supplier" ? "justify-end" : "justify-start"
                  )}
                >
                  <div
                    className={cn(
                  ...
                  >
                    <p className={cn(
                      ...
                      message.from === "supplier" ? "text-black" : "text-white"
                    )}>{message.text}</p>
